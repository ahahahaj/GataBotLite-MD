...
*☆═━┈◈ ╰  ${vs} غيغا بايت ◈┈━═☆*
*◈⇜ ㊂ 
هااااااااااام : جاري التعديل على البوت 
وها شكل مقدم فقط للتجربه
*◈⇜ ㊂ الموقع الرسمي : 
https://cutt.us/ZeroTwoBot
*◈⇜ ㊂ ▸▸معلومات القائمه ◂◂*
*◈⇜* ┊
...
handler.command = /^(menu|اوامر|memu|الاوامر|help|info|comandos|2help|menu1.2|ayuda|commands|commandos|menucompleto|allmenu|allm|m|\?)$/i
